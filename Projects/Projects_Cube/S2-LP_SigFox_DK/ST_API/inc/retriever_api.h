...
/** @addtogroup ST_SIGFOX_RETRIEVER                     Sigfox Retriever Lib
* @{
*/
...
/** @defgroup RETRIEVER Functions				Sigfox Retriever Functions
* @{
*/
...
/*!******************************************************************
 * \fn retr_error_t enc_utils_retrieve_data_from_flash(NVM_BoardDataType *nvmBoardData)
 * \brief Retrieve board informations accordint to the NVM_BoardDataType and returns it to the caller.
 *
 * \param[out] nvmBoardData: pointer to a struct of the type of NVM_BoardDataType.
 * \param[in] UIDAddress: address of MCU UID (for KEY_ENC_VARIABLE only. Otherwise don't care).
 * \param[in] UIDLen: length of MCU UID. Max is 16 (for KEY_ENC_VARIABLE only. Otherwise don't care).
 * \retval Error code: RETR_OK (0) or RETR_ERR (1)
 *******************************************************************/
uint8_t enc_utils_retrieve_data_from_flash(NVM_BoardDataType *nvmBoardData, uint32_t UIDAddress, uint8_t UIDLen);
