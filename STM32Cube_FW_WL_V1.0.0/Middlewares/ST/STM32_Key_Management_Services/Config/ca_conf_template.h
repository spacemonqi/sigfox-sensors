...
/**
  ...
  */
#define CA_ROUTE_AES_CBC  (CA_ROUTE_DEFAULT | CA_ROUTE_AES_CFG_DEFAULT)
...
/**
  ...
  * @note  You can use @ref CA_ROUTE_AES_CFG_DEFAULT to use default AES algorithm configuration
  */
#define CA_ROUTE_AES_CCM  (CA_ROUTE_DEFAULT | CA_ROUTE_AES_CFG_DEFAULT)
...
/**
  ...
  * @note  You can use @ref CA_ROUTE_AES_CFG_DEFAULT to use default AES algorithm configuration
  */
#define CA_ROUTE_AES_CMAC  (CA_ROUTE_DEFAULT | CA_ROUTE_AES_CFG_DEFAULT)
...
/**
  ...
  * @note  You can use @ref CA_ROUTE_AES_CFG_DEFAULT to use default AES algorithm configuration
  */
#define CA_ROUTE_AES_ECB  (CA_ROUTE_DEFAULT | CA_ROUTE_AES_CFG_DEFAULT)
...
/**
  ...
  * @note  You can use @ref CA_ROUTE_AES_CFG_DEFAULT to use default AES algorithm configuration
  */
#define CA_ROUTE_AES_GCM  (CA_ROUTE_DEFAULT | CA_ROUTE_AES_CFG_DEFAULT)
...
/**
  ...
  * @note  You can use @ref CA_ROUTE_DEFAULT to use default route
  */
#define CA_ROUTE_HASH_SHA256  (CA_ROUTE_DEFAULT)
...
/**
  ...
  */
#define CA_ROUTE_ECC_ECDSA  (CA_ROUTE_DEFAULT | CA_ROUTE_ECC_CFG_DEFAULT)
...
/**
  ...
  */
#define CA_ROUTE_RSA  (CA_ROUTE_DEFAULT | CA_ROUTE_RSA_CFG_DEFAULT)
