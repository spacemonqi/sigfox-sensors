...
- active (boolean | a value equal to: 'partial', 'exact'; default False): Apply 'active' style to this component. Set to "exact" to automatically
...
- target (string; optional): Target attribute to pass on to the link. Only applies to external links."""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, href=Component.UNDEFINED, active=Component.UNDEFINED, disabled=Component.UNDEFINED, external_link=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, loading_state=Component.UNDEFINED, target=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'key', 'href', 'active', 'disabled', 'external_link', 'n_clicks', 'n_clicks_timestamp', 'loading_state', 'target']
        self._type = 'NavLink'
        self._namespace = 'dash_bootstrap_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'key', 'href', 'active', 'disabled', 'external_link', 'n_clicks', 'n_clicks_timestamp', 'loading_state', 'target']
