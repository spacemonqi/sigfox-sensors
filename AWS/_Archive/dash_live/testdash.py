...
@app.callback(Output('live-graph-index', 'figure'), [Input('graph-update', 'interval')])
...
@app.callback(Output('sentiment-pie', 'figure'), [Input('graph-update', 'interval')])
...
@app.callback(Output('live-table', 'rows'),[Input('graph-update', 'interval')])
def update_table():
    temp2 = crawl()[1]
