...
layout = html.Div([
    dbc.Container([
        dbc.Row([
            dbc.Col(html.H1(children='Sigfox Sensor Network'), className="mb-2")
        ]),
        dbc.Row([
            dbc.Col(html.H6(children='Visualising humidity, pressure and temperature trends'), className="mb-4")
        ]),
...
# for some reason, font colour remains black if using the color option
    dbc.Row([
        dbc.Col(dbc.Card(html.H3(children="All sensor data",
