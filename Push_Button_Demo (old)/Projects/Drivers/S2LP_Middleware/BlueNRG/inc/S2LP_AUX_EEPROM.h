/**
* @file    S2LP_AUX_EEPROM.h
* @author  LowPower RF BU - AMG
* @version 4.0.0
* @date    March, 2020
* @brief   S2LP AUX EEPROM management
* @details This module exports API to manage the EEPROM of the S2-LP eval boards.
...
#ifndef S2LP_AUX_EEPROM_H_
#define S2LP_AUX_EEPROM_H_
